"""
Django settings for demo_41383 project.
...
WSGI_APPLICATION = 'demo_41383.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_41383 API",
    "DESCRIPTION": "API documentation for demo_41383 App",
    "VERSION": "v1",
}
